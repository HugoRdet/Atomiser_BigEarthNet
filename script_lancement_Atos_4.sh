...
sh Eval_modalities.sh "$EXPERIMENT_NAME" "$MODEL_NAME" train_1
sh Eval_modalities.sh "$EXPERIMENT_NAME" "$MODEL_NAME" train_2
sh Eval_modalities.sh "$EXPERIMENT_NAME" "$MODEL_NAME" train_3