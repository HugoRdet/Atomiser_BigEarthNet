...
class Tiny_BigEarthNet_MAE(Dataset):
    def __init__(self, file_path, 
        ...
        #input_size=(224, 224),
        #mask_ratio_range=(0.5, 0.6),       # mask 50–60% of the image
        #patch_ratio_range=(0.1, 0.25),     # each patch is 10–25% of image height
        #aspect_ratio_range=(0.5, 2.0)      # rectangular patches
    ...
    def get_position_coordinates(self, image_shape, new_resolution):
        ...
        #resolution coordinates for the lookup table
        tmp_resolution = int(10.0/new_resolution*1000)
        global_offset = self.look_up.table[(tmp_resolution, image_size)]
