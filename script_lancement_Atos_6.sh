...
sh Eval_modalities.sh "$EXPERIMENT_NAME" "$MODEL_NAME" Big
sh Eval_modalities.sh "$EXPERIMENT_NAME" "$MODEL_NAME" add_1
sh Eval_modalities.sh "$EXPERIMENT_NAME" "$MODEL_NAME" add_2
